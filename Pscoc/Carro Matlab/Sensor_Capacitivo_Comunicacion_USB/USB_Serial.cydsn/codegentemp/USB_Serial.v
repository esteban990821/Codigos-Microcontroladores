// ======================================================================
// USB_Serial.v generated from TopDesign.cysch
// 05/11/2019 at 21:54
...
module top ;
	...
	wire [0:0] tmpOE__Entrada_net;
	wire [0:0] tmpFB_0__Entrada_net;
	wire [0:0] tmpIO_0__Entrada_net;
	wire [0:0] tmpINTERRUPT_0__Entrada_net;
	electrical [0:0] tmpSIOVREF__Entrada_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Entrada
		 (.oe(tmpOE__Entrada_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Entrada_net[0:0]}),
		  .analog({Net_3}),
		  .io({tmpIO_0__Entrada_net[0:0]}),
		  .siovref(tmpSIOVREF__Entrada_net),
		  .interrupt({tmpINTERRUPT_0__Entrada_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Entrada_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Entrada2_net;
	wire [0:0] tmpFB_0__Entrada2_net;
	wire [0:0] tmpIO_0__Entrada2_net;
	wire [0:0] tmpINTERRUPT_0__Entrada2_net;
	electrical [0:0] tmpSIOVREF__Entrada2_net;

	cy_psoc3_pins_v1_10
		#(.id("081af457-1374-41ad-9401-d835dd303f8a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Entrada2
		 (.oe(tmpOE__Entrada2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Entrada2_net[0:0]}),
		  .analog({Net_10}),
		  .io({tmpIO_0__Entrada2_net[0:0]}),
		  .siovref(tmpSIOVREF__Entrada2_net),
		  .interrupt({tmpINTERRUPT_0__Entrada2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Entrada2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
