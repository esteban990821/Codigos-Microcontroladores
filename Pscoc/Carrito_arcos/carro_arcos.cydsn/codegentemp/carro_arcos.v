// ======================================================================
// carro_arcos.v generated from TopDesign.cysch
// 07/03/2019 at 19:32
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONFIG_TITLE=ADC1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC1, CY_INSTANCE_SHORT_NAME=ADC1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC1, )
...
module top ;
	...
	wire [0:0] tmpOE__PWMS1_1_net;
	wire [0:0] tmpFB_0__PWMS1_1_net;
	wire [0:0] tmpIO_0__PWMS1_1_net;
	wire [0:0] tmpINTERRUPT_0__PWMS1_1_net;
	electrical [0:0] tmpSIOVREF__PWMS1_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWMS1_1
		 (.oe(tmpOE__PWMS1_1_net),
		  .y({Net_29}),
		  .fb({tmpFB_0__PWMS1_1_net[0:0]}),
		  .io({tmpIO_0__PWMS1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMS1_1_net),
		  .interrupt({tmpINTERRUPT_0__PWMS1_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMS1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWMS2_2_net;
	wire [0:0] tmpFB_0__PWMS2_2_net;
	wire [0:0] tmpIO_0__PWMS2_2_net;
	wire [0:0] tmpINTERRUPT_0__PWMS2_2_net;
	electrical [0:0] tmpSIOVREF__PWMS2_2_net;

	cy_psoc3_pins_v1_10
		#(.id("962275bd-6eca-4531-a6b8-98f455606f59"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWMS2_2
		 (.oe(tmpOE__PWMS2_2_net),
		  .y({Net_349}),
		  .fb({tmpFB_0__PWMS2_2_net[0:0]}),
		  .io({tmpIO_0__PWMS2_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMS2_2_net),
		  .interrupt({tmpINTERRUPT_0__PWMS2_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMS2_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("cd64081a-2050-47a2-80ae-4b59e1a5947f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__E1_net;
	wire [0:0] tmpFB_0__E1_net;
	wire [0:0] tmpIO_0__E1_net;
	wire [0:0] tmpINTERRUPT_0__E1_net;
	electrical [0:0] tmpSIOVREF__E1_net;
	...
	cy_psoc3_pins_v1_10
		...
		E1
		 (.oe(tmpOE__E1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__E1_net[0:0]}),
		  .io({tmpIO_0__E1_net[0:0]}),
		  .siovref(tmpSIOVREF__E1_net),
		  .interrupt({tmpINTERRUPT_0__E1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__E1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PWMS2_1_net;
	wire [0:0] tmpFB_0__PWMS2_1_net;
	wire [0:0] tmpIO_0__PWMS2_1_net;
	wire [0:0] tmpINTERRUPT_0__PWMS2_1_net;
	electrical [0:0] tmpSIOVREF__PWMS2_1_net;

	cy_psoc3_pins_v1_10
		#(.id("fa0d3e85-f171-4704-ab09-aa550d72a3e2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWMS2_1
		 (.oe(tmpOE__PWMS2_1_net),
		  .y({Net_97}),
		  .fb({tmpFB_0__PWMS2_1_net[0:0]}),
		  .io({tmpIO_0__PWMS2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMS2_1_net),
		  .interrupt({tmpINTERRUPT_0__PWMS2_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMS2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_2 PWM_3 (
        ...
        .ph1(Net_629),
        .ph2(Net_630));
    defparam PWM_3.Resolution = 8;

    assign Net_94 = 1'h0;


	cy_clock_v1_0
		#(.id("8c5fa396-a1a2-46bd-9008-d0038bcb47db"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f254a2b5-dab1-4d6a-beb1-494592d437c8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("16186460-7887-4b71-8542-a1f29ce0ec72"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__PWMS1_2_net;
	wire [0:0] tmpFB_0__PWMS1_2_net;
	wire [0:0] tmpIO_0__PWMS1_2_net;
	wire [0:0] tmpINTERRUPT_0__PWMS1_2_net;
	electrical [0:0] tmpSIOVREF__PWMS1_2_net;

	cy_psoc3_pins_v1_10
		#(.id("649aa115-07dc-4f1b-868a-42415eda2fb5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWMS1_2
		 (.oe(tmpOE__PWMS1_2_net),
		  .y({Net_540}),
		  .fb({tmpFB_0__PWMS1_2_net[0:0]}),
		  .io({tmpIO_0__PWMS1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMS1_2_net),
		  .interrupt({tmpINTERRUPT_0__PWMS1_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMS1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("968d32af-dd87-4f08-9655-8a62da18411a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Temperatura_net;
	wire [0:0] tmpFB_0__Temperatura_net;
	wire [0:0] tmpIO_0__Temperatura_net;
	wire [0:0] tmpINTERRUPT_0__Temperatura_net;
	electrical [0:0] tmpSIOVREF__Temperatura_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("081af457-1374-41ad-9401-d835dd303f8a"),
		  ...
		  .input_buffer_sel(2'b00))
		Temperatura
		 (.oe(tmpOE__Temperatura_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Temperatura_net[0:0]}),
		  .analog({Net_10}),
		  .io({tmpIO_0__Temperatura_net[0:0]}),
		  .siovref(tmpSIOVREF__Temperatura_net),
		  .interrupt({tmpINTERRUPT_0__Temperatura_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Temperatura_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
