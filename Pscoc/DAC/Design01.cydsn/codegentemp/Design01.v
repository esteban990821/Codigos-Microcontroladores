...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("748673bc-7014-4103-bef4-b299d8f35143/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("748673bc-7014-4103-bef4-b299d8f35143/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0a499af9-003e-4f0b-89a0-46022038533e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam VDAC8.Initial_Value = 150;
	...
	wire [0:0] tmpOE__aumentar_net;
	wire [0:0] tmpIO_0__aumentar_net;
	wire [0:0] tmpINTERRUPT_0__aumentar_net;
	electrical [0:0] tmpSIOVREF__aumentar_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		aumentar
		 (.oe(tmpOE__aumentar_net),
		  .y({1'b0}),
		  .fb({Net_14}),
		  .io({tmpIO_0__aumentar_net[0:0]}),
		  .siovref(tmpSIOVREF__aumentar_net),
		  .interrupt({tmpINTERRUPT_0__aumentar_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__aumentar_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
