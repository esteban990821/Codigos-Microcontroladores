...
/* vin */
#define vin__0__INTTYPE CYREG_PICU3_INTTYPE6
#define vin__0__MASK 0x40u
#define vin__0__PC CYREG_PRT3_PC6
#define vin__0__PORT 3u
#define vin__0__SHIFT 6u
...
/* vout */
#define vout__0__INTTYPE CYREG_PICU3_INTTYPE7
#define vout__0__MASK 0x80u
#define vout__0__PC CYREG_PRT3_PC7
#define vout__0__PORT 3u
#define vout__0__SHIFT 7u
...
/* aumentar */
#define aumentar__0__INTTYPE CYREG_PICU2_INTTYPE2
#define aumentar__0__MASK 0x04u
#define aumentar__0__PC CYREG_PRT2_PC2
#define aumentar__0__PORT 2u
#define aumentar__0__SHIFT 2u
#define aumentar__AG CYREG_PRT2_AG
#define aumentar__AMUX CYREG_PRT2_AMUX
#define aumentar__BIE CYREG_PRT2_BIE
#define aumentar__BIT_MASK CYREG_PRT2_BIT_MASK
#define aumentar__BYP CYREG_PRT2_BYP
#define aumentar__CTL CYREG_PRT2_CTL
#define aumentar__DM0 CYREG_PRT2_DM0
#define aumentar__DM1 CYREG_PRT2_DM1
#define aumentar__DM2 CYREG_PRT2_DM2
#define aumentar__DR CYREG_PRT2_DR
#define aumentar__INP_DIS CYREG_PRT2_INP_DIS
#define aumentar__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define aumentar__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define aumentar__LCD_EN CYREG_PRT2_LCD_EN
#define aumentar__MASK 0x04u
#define aumentar__PORT 2u
#define aumentar__PRT CYREG_PRT2_PRT
#define aumentar__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define aumentar__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define aumentar__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define aumentar__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define aumentar__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define aumentar__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define aumentar__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define aumentar__PS CYREG_PRT2_PS
#define aumentar__SHIFT 2u
#define aumentar__SLW CYREG_PRT2_SLW

/* israumentar */
#define israumentar__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define israumentar__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define israumentar__INTC_MASK 0x01u
#define israumentar__INTC_NUMBER 0u
#define israumentar__INTC_PRIOR_NUM 7u
#define israumentar__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define israumentar__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define israumentar__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
