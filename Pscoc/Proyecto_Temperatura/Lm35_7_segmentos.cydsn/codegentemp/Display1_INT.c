...
CY_ISR(Display1_ISR)
{
    #ifdef Display1_ISR_INTERRUPT_CALLBACK
        Display1_ISR_InterruptCallback();
    #endif /* Display1_ISR_INTERRUPT_CALLBACK */
