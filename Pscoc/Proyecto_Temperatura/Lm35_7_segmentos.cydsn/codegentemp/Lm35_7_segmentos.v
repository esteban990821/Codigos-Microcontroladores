// ======================================================================
// Lm35_7_segmentos.v generated from TopDesign.cysch
// 04/01/2020 at 20:52
...
module top ;
	...
	wire [0:0] tmpOE__SLED1_net;
	wire [0:0] tmpFB_0__SLED1_net;
	wire [0:0] tmpIO_0__SLED1_net;
	wire [0:0] tmpINTERRUPT_0__SLED1_net;
	electrical [0:0] tmpSIOVREF__SLED1_net;
	...
	cy_psoc3_pins_v1_10
		...
		SLED1
		 (.oe(tmpOE__SLED1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SLED1_net[0:0]}),
		  .io({tmpIO_0__SLED1_net[0:0]}),
		  .siovref(tmpSIOVREF__SLED1_net),
		  .interrupt({tmpINTERRUPT_0__SLED1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SLED1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SLED2_net;
	wire [0:0] tmpFB_0__SLED2_net;
	wire [0:0] tmpIO_0__SLED2_net;
	wire [0:0] tmpINTERRUPT_0__SLED2_net;
	electrical [0:0] tmpSIOVREF__SLED2_net;

	cy_psoc3_pins_v1_10
		#(.id("e500aca6-0f21-4031-8b29-611ab4f663fb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SLED2
		 (.oe(tmpOE__SLED2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SLED2_net[0:0]}),
		  .io({tmpIO_0__SLED2_net[0:0]}),
		  .siovref(tmpSIOVREF__SLED2_net),
		  .interrupt({tmpINTERRUPT_0__SLED2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SLED2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
