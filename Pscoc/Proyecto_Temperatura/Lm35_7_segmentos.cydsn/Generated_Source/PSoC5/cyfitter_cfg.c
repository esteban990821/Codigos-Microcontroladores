...
#define BS_UDB_0_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x480002D8u)
...
#define BS_IOPINS1_0_VAL ((const uint8 CYFAR *)0x48000360u)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000368u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000374u)
...
/* IOPINS1_2 Address: CYREG_PRT2_DM0 + 0x00000009u Size (bytes): 5 */
#define BS_IOPINS1_2_VAL ((const uint8 CYFAR *)0x4800038Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000394u)

/* IOPINS1_3 Address: CYREG_PRT3_DM0 + 0x00000009u Size (bytes): 5 */
#define BS_IOPINS1_3_VAL ((const uint8 CYFAR *)0x4800039Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x61A7u);
...
const struct CY_DMA_TD_PROTO_ENTRY CYCODE Display1_Seg__DMA_TD_PROTO_BLOCK[2] =
{
    {0, 1},
    {2, 2},
};
...
void cyfitter_cfg(void)
{
	...
	CYCONFIGCPY((void CYFAR *)(CYREG_PRT2_DM0 + 0x00000009u), (const void CYFAR *)(BS_IOPINS1_2_VAL), 5u);
