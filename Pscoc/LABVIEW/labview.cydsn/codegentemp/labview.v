...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("f03f20eb-cadb-4c56-ae30-5667e42f98c6/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("f03f20eb-cadb-4c56-ae30-5667e42f98c6/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=24, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=384, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC2, CY_INSTANCE_SHORT_NAME=VDAC2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC2, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=18, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=288, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC1, CY_INSTANCE_SHORT_NAME=VDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC1, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=24, RunMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter2, CY_INSTANCE_SHORT_NAME=Counter2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter2, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=128, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=255, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=24, RunMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter1, CY_INSTANCE_SHORT_NAME=Counter1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter1, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=125, CompareValue2=63, CONTROL3=0, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=1199, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=true, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=false, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM1, CY_INSTANCE_SHORT_NAME=PWM1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM1, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=125, CompareValue2=63, CONTROL3=0, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=1100, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=true, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=false, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM0, CY_INSTANCE_SHORT_NAME=PWM0, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM0, )
module PWM_v3_30_8 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    defparam MUX.muxin_width = 8;
    defparam MUX.init_mux_sel = 8'h0;
	...
	cy_psoc3_pins_v1_10
		#(.id("6726b0b9-f392-47c6-9e6c-b1403f3e58a8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("59fc045a-b22a-4fa6-b507-767e840ac26f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b11e274a-ae3b-453f-b9c6-77957abeb5ab"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4bc41557-a125-4563-92ab-97758aa99f9a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("44c2bca9-de48-4515-8b7c-80b2f531f473"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("763613f9-ec4b-4927-9522-733564252524"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fde81374-d081-45e4-b1cf-28c96e9b5ddb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("236f98cc-5abc-427d-85ba-a174cecf0c6c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SalidaD1_net;
	wire [0:0] tmpFB_0__SalidaD1_net;
	wire [0:0] tmpIO_0__SalidaD1_net;
	wire [0:0] tmpINTERRUPT_0__SalidaD1_net;
	electrical [0:0] tmpSIOVREF__SalidaD1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SalidaD1
		 (.oe(tmpOE__SalidaD1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SalidaD1_net[0:0]}),
		  .io({tmpIO_0__SalidaD1_net[0:0]}),
		  .siovref(tmpSIOVREF__SalidaD1_net),
		  .interrupt({tmpINTERRUPT_0__SalidaD1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SalidaD1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SalidaD0_net;
	wire [0:0] tmpFB_0__SalidaD0_net;
	wire [0:0] tmpIO_0__SalidaD0_net;
	wire [0:0] tmpINTERRUPT_0__SalidaD0_net;
	electrical [0:0] tmpSIOVREF__SalidaD0_net;

	cy_psoc3_pins_v1_10
		#(.id("7f80aad5-5204-4b18-93e7-2eca568cdee5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SalidaD0
		 (.oe(tmpOE__SalidaD0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SalidaD0_net[0:0]}),
		  .io({tmpIO_0__SalidaD0_net[0:0]}),
		  .siovref(tmpSIOVREF__SalidaD0_net),
		  .interrupt({tmpINTERRUPT_0__SalidaD0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SalidaD0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SalidaD2_net;
	wire [0:0] tmpFB_0__SalidaD2_net;
	wire [0:0] tmpIO_0__SalidaD2_net;
	wire [0:0] tmpINTERRUPT_0__SalidaD2_net;
	electrical [0:0] tmpSIOVREF__SalidaD2_net;

	cy_psoc3_pins_v1_10
		#(.id("bfd3153c-55c8-4911-8129-1fc02f41ed12"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SalidaD2
		 (.oe(tmpOE__SalidaD2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SalidaD2_net[0:0]}),
		  .io({tmpIO_0__SalidaD2_net[0:0]}),
		  .siovref(tmpSIOVREF__SalidaD2_net),
		  .interrupt({tmpINTERRUPT_0__SalidaD2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SalidaD2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam VDAC2.Initial_Value = 24;
    ...
    defparam VDAC1.Initial_Value = 18;
    defparam VDAC1.Strobe_Mode = 0;

	wire [0:0] tmpOE__DAC2_net;
	wire [0:0] tmpFB_0__DAC2_net;
	wire [0:0] tmpIO_0__DAC2_net;
	wire [0:0] tmpINTERRUPT_0__DAC2_net;
	electrical [0:0] tmpSIOVREF__DAC2_net;

	cy_psoc3_pins_v1_10
		#(.id("c113dd64-c5c7-417a-963e-4c40128a0a8b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DAC2
		 (.oe(tmpOE__DAC2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC2_net[0:0]}),
		  .analog({Net_60}),
		  .io({tmpIO_0__DAC2_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC2_net),
		  .interrupt({tmpINTERRUPT_0__DAC2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DAC2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DAC1_net;
	wire [0:0] tmpFB_0__DAC1_net;
	wire [0:0] tmpIO_0__DAC1_net;
	wire [0:0] tmpINTERRUPT_0__DAC1_net;
	electrical [0:0] tmpSIOVREF__DAC1_net;

	cy_psoc3_pins_v1_10
		#(.id("84c062e9-d51d-4c36-a2cc-9bc2f295685e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DAC1
		 (.oe(tmpOE__DAC1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC1_net[0:0]}),
		  .analog({Net_80}),
		  .io({tmpIO_0__DAC1_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC1_net),
		  .interrupt({tmpINTERRUPT_0__DAC1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DAC1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("242307b8-ae66-46bf-9150-b4ef7878628d"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000000"),
		  .is_direct(0),
    ...
    Counter_v3_0_5 Counter2 (
        ...
        .up_ndown(1'b1),
        .count(Net_144));
    defparam Counter2.CaptureMode = 0;
    defparam Counter2.ClockMode = 0;
    defparam Counter2.CompareMode = 1;
    defparam Counter2.CompareStatusEdgeSense = 1;
    defparam Counter2.EnableMode = 0;
    defparam Counter2.ReloadOnCapture = 0;
    defparam Counter2.ReloadOnCompare = 0;
    defparam Counter2.ReloadOnOverUnder = 1;
    defparam Counter2.ReloadOnReset = 1;
    defparam Counter2.Resolution = 24;
    defparam Counter2.RunMode = 0;
    defparam Counter2.UseInterrupt = 1;

    Counter_v3_0_6 Counter1 (
        .reset(Net_121),
        .tc(Net_122),
        .comp(Net_123),
        .clock(Net_124),
        ...
        .up_ndown(1'b1),
        .count(Net_131));
    defparam Counter1.CaptureMode = 0;
    defparam Counter1.ClockMode = 0;
    defparam Counter1.CompareMode = 1;
    defparam Counter1.CompareStatusEdgeSense = 1;
    defparam Counter1.EnableMode = 0;
    defparam Counter1.ReloadOnCapture = 0;
    defparam Counter1.ReloadOnCompare = 0;
    defparam Counter1.ReloadOnOverUnder = 1;
    defparam Counter1.ReloadOnReset = 1;
    defparam Counter1.Resolution = 24;
    defparam Counter1.RunMode = 0;
    defparam Counter1.UseInterrupt = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("03d8dc35-53df-400f-8013-0ff4859ef29a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("e43fc929-ce5a-42de-87c7-45c41f382423"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__pin2_net;
	wire [0:0] tmpFB_0__pin2_net;
	wire [0:0] tmpIO_0__pin2_net;
	wire [0:0] tmpINTERRUPT_0__pin2_net;
	electrical [0:0] tmpSIOVREF__pin2_net;

	cy_psoc3_pins_v1_10
		#(.id("74fbc55d-5c1f-4d07-a6f6-192c18be13dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		pin2
		 (.oe(tmpOE__pin2_net),
		  .y({Net_732}),
		  .fb({tmpFB_0__pin2_net[0:0]}),
		  .io({tmpIO_0__pin2_net[0:0]}),
		  .siovref(tmpSIOVREF__pin2_net),
		  .interrupt({tmpINTERRUPT_0__pin2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin1_net;
	wire [0:0] tmpFB_0__pin1_net;
	wire [0:0] tmpIO_0__pin1_net;
	wire [0:0] tmpINTERRUPT_0__pin1_net;
	electrical [0:0] tmpSIOVREF__pin1_net;

	cy_psoc3_pins_v1_10
		#(.id("10af5b48-8c8c-4e7d-9afe-3101c1e68ce1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_8 PWM0 (
        ...
        .ph1(Net_727),
        .ph2(Net_728));
    defparam PWM0.Resolution = 16;


	cy_clock_v1_0
		#(.id("f3e65dd9-f65a-4247-a9ec-d8388e33c72f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
