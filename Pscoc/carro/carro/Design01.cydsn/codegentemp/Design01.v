...
module top ;
	...
	wire [0:0] tmpOE__pin3_net;
	wire [0:0] tmpFB_0__pin3_net;
	wire [0:0] tmpIO_0__pin3_net;
	wire [0:0] tmpINTERRUPT_0__pin3_net;
	electrical [0:0] tmpSIOVREF__pin3_net;

	cy_psoc3_pins_v1_10
		#(.id("c2d0483d-b5ea-48e2-9ad7-5567110d5787"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		pin3
		 (.oe(tmpOE__pin3_net),
		  .y({Net_302}),
		  .fb({tmpFB_0__pin3_net[0:0]}),
		  .io({tmpIO_0__pin3_net[0:0]}),
	...
	assign tmpOE__pin3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pin4_net;
	wire [0:0] tmpFB_0__pin4_net;
	wire [0:0] tmpIO_0__pin4_net;
	wire [0:0] tmpINTERRUPT_0__pin4_net;
	electrical [0:0] tmpSIOVREF__pin4_net;

	cy_psoc3_pins_v1_10
		#(.id("9709737c-efcc-4e46-a4cb-52e874080824"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		pin4
		 (.oe(tmpOE__pin4_net),
		  .y({Net_303}),
		  .fb({tmpFB_0__pin4_net[0:0]}),
		  .io({tmpIO_0__pin4_net[0:0]}),
		  .siovref(tmpSIOVREF__pin4_net),
		  .interrupt({tmpINTERRUPT_0__pin4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("8f8141bf-7e99-4a49-968d-9a1f819a27cd"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__filtro1_net;
	wire [0:0] tmpFB_0__filtro1_net;
	wire [0:0] tmpIO_0__filtro1_net;
	wire [0:0] tmpINTERRUPT_0__filtro1_net;
	electrical [0:0] tmpSIOVREF__filtro1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		filtro1
		 (.oe(tmpOE__filtro1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__filtro1_net[0:0]}),
		  .io({tmpIO_0__filtro1_net[0:0]}),
		  .siovref(tmpSIOVREF__filtro1_net),
		  .interrupt({tmpINTERRUPT_0__filtro1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__filtro1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__filtro2_net;
	wire [0:0] tmpFB_0__filtro2_net;
	wire [0:0] tmpIO_0__filtro2_net;
	wire [0:0] tmpINTERRUPT_0__filtro2_net;
	electrical [0:0] tmpSIOVREF__filtro2_net;

	cy_psoc3_pins_v1_10
		#(.id("d519982b-b861-46c4-9602-dc6988040779"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		filtro2
		 (.oe(tmpOE__filtro2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__filtro2_net[0:0]}),
		  .io({tmpIO_0__filtro2_net[0:0]}),
		  .siovref(tmpSIOVREF__filtro2_net),
		  .interrupt({tmpINTERRUPT_0__filtro2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__filtro2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
