...
{
    /* Set pins drive mode */
    CyPins_SetPinDriveMode(CapSense_PortCH0__B1__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__B2__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LS_e0__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LS_e1__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LS_e2__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LS_e3__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LS_e4__LS, mode);
