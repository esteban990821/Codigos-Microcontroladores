...
/* Define Sensors */
#define CapSense_SENSOR_B2__BTN    (0u)
#define CapSense_SENSOR_B1__BTN    (1u)
#define CapSense_SENSOR_LS_E0__LS    (2u)
#define CapSense_SENSOR_LS_E1__LS    (3u)
#define CapSense_SENSOR_LS_E2__LS    (4u)
#define CapSense_SENSOR_LS_E3__LS    (5u)
#define CapSense_SENSOR_LS_E4__LS    (6u)
