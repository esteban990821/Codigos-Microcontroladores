                                  ...
                                  
{
    ...
    /* Was on */
    if (0u != (CapSense_1_sensorOnMask[pos] & onMask))
    {
        /* Hysteresis minus */
        if (CapSense_1_sensorSignal[sensor] < (fingerThreshold - hysteresis))
        {
            CapSense_1_sensorOnMask[pos] &= (uint8)~onMask;
    ...
    return (((CapSense_1_sensorOnMask[pos] & onMask) != 0u) ? 1u : 0u);
}
                                    ...
                                    
{
    ...
    do
    {
        ...
        CapSense_1_sensorEnableMask[pos] &= (uint8)~enMask;
        rawIndex++;
    }
    while(rawIndex < numberOfSensors);
    ...
    *******************************************************************************/
	                                          ...
	                                          
    {
        ...
        if (0u != CapSense_1_CheckIsWidgetActive(widget))
        {
