...
char recibir, cadena[],cadena2[4], longitud=0, str[12], publicar[12],publicar1[12],publicar2[12]; 
int bandera=0, canal=0, ganancia=0, signal,numero[12],dato,valor,cuenta,acu=0,DAC,VDAC,guardado1,guardado2;
float32 Vin;
void Input();
void Output();
void Contador();
