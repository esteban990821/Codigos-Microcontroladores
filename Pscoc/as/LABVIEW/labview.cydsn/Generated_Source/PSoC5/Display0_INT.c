...
CY_ISR(Display0_ISR)
{
    #ifdef Display0_ISR_INTERRUPT_CALLBACK
        Display0_ISR_InterruptCallback();
    #endif /* Display0_ISR_INTERRUPT_CALLBACK */
...
/******************************************************************************
* Function Name: Display0_WAKEUP_ISR
*******************************************************************************
*
* Summary:
...
*
******************************************************************************/
CY_ISR(Display0_WAKEUP_ISR)
{
    #ifdef Display0_WAKEUP_ISR_INTERRUPT_CALLBACK
        Display0_WAKEUP_ISR_InterruptCallback();
    #endif /* Display0_WAKEUP_ISR_INTERRUPT_CALLBACK */
