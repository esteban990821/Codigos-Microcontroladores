...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x4800002Cu)

/* IOPINS1_0 Address: CYREG_PRT0_DM0 + 0x00000009u Size (bytes): 5 */
#define BS_IOPINS1_0_VAL ((const uint8 CYFAR *)0x48000034u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800003Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000044u)

/* IOPINS1_3 Address: CYREG_PRT3_DM0 + 0x00000009u Size (bytes): 5 */
#define BS_IOPINS1_3_VAL ((const uint8 CYFAR *)0x4800004Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x61A7u);
